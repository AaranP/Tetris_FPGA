; C:\TETRIS_FINAL_AP_V1\PROGRAMS\DEBUGMONITORCODE\TETRIS_TESTING.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
; #include <stdio.h>
; #include <stdlib.h>
; #include <limits.h>
; #include "tetris.h"
...
; char GameOn;
; int tetris_timer;
; //Color array for potential colored tetris block implementation
; int color_def[] = {RED_COLOR, BLUE_COLOR, GREEN_COLOR, YELLOW_COLOR, MAGENTA_COLOR, WHITE_COLOR, CYAN_COLOR}; 
; typedef struct {
...
gameOver_8:
; }
; //loops through colors of the game over screen 
; j=2;
       moveq     #2,D3
; while (j!=0) {
gameOver_9:
...
@tetris~1_4:
       dc.b      80,114,101,115,115,32,115,111,109,101,116,104
       dc.b      105,110,103,32,116,111,32,99,111,110,116,105
       dc.b      110,117,101,0
@tetris~1_5:
       dc.b      10,10,10,0
@tetris~1_6:
